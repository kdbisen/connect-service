...
import com.adyanta.connect.service.FenergoApiClient;
...
/**
 * KYC processing processor using annotation-based routing
 * Handles ADD_KYC request type with specific processing steps:
...
public class KycProcessor {
     ...
     * This method will be automatically called for ADD_KYC requests
     */
    @ProcessRequestType(
